...
public class Client extends AbstractActor {
    ...
    public static void main(String[] args) {
        ...
        ActorSystem system = ActorSystem.create("echo");
        ActorRef listener = system.actorOf(Props.create(SimplisticHandler.class), "listener");
        ActorRef client = system.actorOf(Client.props(address, listener));
    }
